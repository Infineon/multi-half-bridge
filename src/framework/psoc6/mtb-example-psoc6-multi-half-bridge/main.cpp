...
// Select the example which is compiled. There are a number of different
// examples defined which can be switched here.
#define EXAMPLE                     ERRORDIAGNOSIS
...
int main(void)
{
	...
	switch (EXAMPLE) {
		...
		case MULTIPLECONTROLLERS:
			...
			// Does not work yet and needs further investigation
